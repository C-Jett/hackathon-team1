export default [{
    ...
    description: "Measure of the extent to which several different racial and ethnic domains are present in a community.",
    domain: "Demographic"
  }, {
    key: '7',
